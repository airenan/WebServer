...
<div style="margin-left:30px;">
    <center><h3 style="font-family: 'Yanone Kaffeesatz', sans-serif; font-size: 45px; margin-bottom: -15px;">Novo Aluno</h3>
    ...
    <form method="post">
        ...
        <input style="width:100px;" class="btn btn-primary" type=submit name="incluir" value="Confirmar" onClick="location.href='index.php'">
    </form>
</center>
</div>
</body>
...
<?php
    ...
    if (isset($_POST['incluir']))
    {
        ...
        $sql = "insert into aluno values ($cod, '$name', '$end', '$tel')";
